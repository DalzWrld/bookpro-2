  ...
  return (
    <div className="h-16 bg-card border-b border-border flex items-center justify-between px-8 flex-shrink-0">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button className="w-9 h-9 rounded-lg border border-border bg-none flex items-center justify-center text-slate hover:bg-surface transition-colors">🔔</button>
      </div>
    </div>
  )
}
